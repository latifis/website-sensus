...
<html lang="en">
  <head>
    ...
    <title> Sensus Online | Data </title>
  </head>
  ...
  <thead class="thead-dark">
   ...
   <div class="fixed-header"><h3 align="center"> List Sensus 2020</h3> </div> <br>
...
<footer class="fixed-footer"> <center> <a href="home.php">  <button type="button" class="btn btn-dark" href='home.php'>Home</button> </a>
</center></footer>
<br><br><br><br>
