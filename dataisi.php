...
<html lang="en">
  ...
  <center>
    <table class="tabelku">
      <tr>
        <img src="img/maaf.gif" width="250pt" height="250pt">
      </tr>
    </table>
  </center><br>
  ...
  <center>
    <table>
      <tr>
        <p style="color: black"> Your Data Can't Uploaded! </p>
        <p style="color: black"> Anda Hanya Dapat Mengisi Data Sekali </p>
        <p style="color: black"> Apabila Ada Kesalahan dalam Penginputan Data, Klik Edit </p>
  ...
  <center>
    <table>
      <tr>
        <a href="edit.php">  <button type="button" class="btn btn-dark" href='main2.php'> Edit </button> </a>
      </tr>
    </table>
  </center>
