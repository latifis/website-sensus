...
<?php
    ...
    $idlog = $_GET['id'];
    $queryy = mysqli_query($db, "SELECT * FROM login WHERE id='$idlog'");
    $datalog = mysqli_fetch_array($queryy);
...
<html lang="en">
  <head>
    ...
    <title> Sensus Online | Input Data </title>
  </head>
  ...
  <center>
    <table class="tabelku">
      <tr>
        <h3 class="buat"> FORM INPUT DATA </h3>
      </tr>
    </table>
  </center>

  <center>
    <form action="input2.php" method="POST" class="px-4 py-3">
       <table class="tabelku">
        <tr>
        ...
        <input type="hidden" name="id1" value="<?php echo $datalog['id'] ?>">
      </form>
  </center>
